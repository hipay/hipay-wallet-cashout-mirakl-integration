        ...
        foreach ($data as $key => $logRow) {
            ...
            if ($logRow['error'] == null && $logRow['endedAt'] == null) {
                ...
                $data[$key]['state'] = array(
                    ...
                    'button' => '<button type="button" class="btn btn-info btn-xs vendor-notice" data-container="body" data-toggle="popover" data-placement="bottom" data-content="'.$this->translator->trans($logRow["error"]).'" data-original-title="" title="" ><i class="glyphicon glyphicon-question-sign" ></i></button>',
                );
            }
        }
