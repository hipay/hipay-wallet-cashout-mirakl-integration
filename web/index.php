...
$app->get('/', function() use ($app) {
    ...
    $rows = array(
        array('mirakl_id'=>'2789','message'=>$message, 'class'=>'danger', 'status'=>'Non créé', 'hipay_id'=>'-', 'document_sent'=>'-',),
        array('mirakl_id'=>'2788','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55999', 'document_sent'=>'5',),
        array('mirakl_id'=>'2787','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55998', 'document_sent'=>'3',),
        array('mirakl_id'=>'2786','message'=>'', 'class'=>'success', 'status'=>'Créé', 'hipay_id'=>'55997', 'document_sent'=>'5',),
        array('mirakl_id'=>'2785','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55996', 'document_sent'=>'4',),
        array('mirakl_id'=>'2784','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55995', 'document_sent'=>'3',),
        array('mirakl_id'=>'2783','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55994', 'document_sent'=>'4',),
        array('mirakl_id'=>'2782','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55993', 'document_sent'=>'4',),
        array('mirakl_id'=>'2781','message'=>$message, 'class'=>'danger', 'status'=>'Non créé', 'hipay_id'=>'-', 'document_sent'=>'-',),
        array('mirakl_id'=>'2780','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55992', 'document_sent'=>'5',),
        array('mirakl_id'=>'2779','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55991', 'document_sent'=>'5',),
    );
...
$app->get('/transferts', function() use ($app) {
    ...
    $message .= 'Pellentesque eu lectus sodales, pharetra libero id, condimentum urna.';
    $rows = array(
        array('mirakl_id'=>'2789','transfert'=>'KO','withdrawal'=>'-','amount'=>'129,99€','balance'=>'0€','message'=>$message, 'class'=>'danger', 'status'=>'Non créé', 'hipay_id'=>'55888',),
        array('mirakl_id'=>'2788','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55999',),
        array('mirakl_id'=>'2787','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55998',),
        array('mirakl_id'=>'2786','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'success', 'status'=>'Créé', 'hipay_id'=>'55997',),
        array('mirakl_id'=>'2785','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55996',),
        array('mirakl_id'=>'2784','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55995',),
        array('mirakl_id'=>'2783','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55994',),
        array('mirakl_id'=>'2782','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55993',),
        array('mirakl_id'=>'2781','transfert'=>'OK','withdrawal'=>'KO','amount'=>'129,99€','balance'=>'20129,99€','message'=>$message, 'class'=>'danger', 'status'=>'Non créé', 'hipay_id'=>'55993',),
        array('mirakl_id'=>'2780','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'warning', 'status'=>'Non identifié', 'hipay_id'=>'55992',),
        array('mirakl_id'=>'2779','transfert'=>'OK','withdrawal'=>'OK','amount'=>'129,99€','balance'=>'20129,99€','message'=>'', 'class'=>'', 'status'=>'Identifié', 'hipay_id'=>'55991',),
    );
