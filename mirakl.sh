...
if [ "$1" = 'test' ]; then
   ...
   casperjs test $pathPreFile ${pathDir}/[6-6]*/[0-9][0-9][0-9][0-9]-*.js --url=$BASE_URL --ignore-ssl-errors=true --ssl-protocol=any --github-token=$4 --login-backend=$2 --pass-backend=$3 --fail-fast
fi
